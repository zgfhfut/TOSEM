...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	fclose(end_ptr1); //关闭文件
		...
		for (int int_exp = 1; int_exp <= MAX_NUM_EXP; int_exp++)
		{
			...
			sprintf_s(file1, "C:\\Users\\shao\\Desktop\\论文代码数据\\experimental data\\multi-input and multi-output\\MOEAD-IEpsilon\\50\\Data of 30 instances\\test%d\\fitness%d.txt", o, int_exp);//在file1中写上每次迭代产生的不同fitness文件的路径
			...
			niter = 25; // maximal number of iterations
